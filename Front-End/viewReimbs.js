...
document.getElementById("resolveReimbBtn").onclick = resolveReimb
...
async function resolveReimb() {
    ...
    if (response.status === 202){
        ...
        p_resolve.textContent = "Reimbursement Successfully Resolved"
    }
    else {
        var p_resolve = document.getElementById("afterResolve");
        p_resolve.textContent = "Failed to resolve Reimbursement"
    }
